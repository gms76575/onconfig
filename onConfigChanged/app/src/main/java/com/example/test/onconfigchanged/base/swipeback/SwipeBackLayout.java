package com.example.test.onconfigchanged.base.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link com.example.test.onconfigchanged.base.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.example.test.onconfigchanged.base.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
